...
const baseURL string = "https://api.subrow.com"
const baseIngestURL string = "https://ingest.subrow.com"
...
func New() *Client {
	...
	restyClient := resty.New().
		...
		SetHeader("User-Agent", "subrow-go-client github.com/subrowio/subrow-go-client/v1")
