...
type Fee struct {
	SubrowID                uuid.UUID `json:"subrow_id,omitempty"`
	SubrowChargeID          uuid.UUID `json:"subrow_charge_id,omitempty"`
	SubrowChargeFilterID    uuid.UUID `json:"subrow_charge_filter_id,omitempty"`
	SubrowInvoiceID         uuid.UUID `json:"subrow_invoice_id,omitempty"`
	SubrowTrueUpFeeID       uuid.UUID `json:"subrow_true_up_fee_id,omitempty"`
	SubrowTrueUpParentFeeID uuid.UUID `json:"subrow_true_up_parent_fee_id,omitempty"`
	ExternalSubscriptionID  string    `json:"external_subscription_id,omitempty"`
...
func (fr *FeeRequest) Update(ctx context.Context, feeInput *FeeUpdateInput) (*Fee, *Error) {
	subPath := fmt.Sprintf("%s/%s", "fees", feeInput.SubrowID)
