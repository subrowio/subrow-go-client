...
var mockResponse = map[string]interface{}{
	"applied_coupons": []map[string]interface{}{
		{
			"subrow_id":                    "1a901a90-1a90-1a90-1a90-1a901a901a90",
			"subrow_coupon_id":             "1a901a90-1a90-1a90-1a90-1a901a901a90",
			"coupon_code":                  "APPLIED_COUPON",
			"coupon_name":                  "Startup Deal",
			"subrow_customer_id":           "1a901a90-1a90-1a90-1a90-1a901a901a90",
			...
			"credits": []map[string]interface{}{
				{
					...
					"item": map[string]interface{}{
						"subrow_item_id": "1a901a90-1a90-1a90-1a90-1a901a901a90",
						"type":           "coupon",
						"code":           "startup_deal",
						"name":           "Startup Deal",
					},
...
func assertAppliedCoupontGetListResponse(c *qt.C, result *AppliedCouponResult) {
	...
	c.Assert(appliedCoupon.SubrowID.String(), qt.Equals, "1a901a90-1a90-1a90-1a90-1a901a901a90")
	c.Assert(appliedCoupon.SubrowCouponID.String(), qt.Equals, "1a901a90-1a90-1a90-1a90-1a901a901a90")
	c.Assert(appliedCoupon.CouponCode, qt.Equals, "APPLIED_COUPON")
	c.Assert(appliedCoupon.CouponName, qt.Equals, "Startup Deal")
	c.Assert(appliedCoupon.SubrowCustomerID.String(), qt.Equals, "1a901a90-1a90-1a90-1a90-1a901a901a90")
	...
	c.Assert(credit.Invoice.SubrowID.String(), qt.Equals, "1a901a90-1a90-1a90-1a90-1a901a901a90")
